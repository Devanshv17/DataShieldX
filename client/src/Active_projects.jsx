...
import {createProject, getUsers, getApps, generateMilestones} from "@/callbacks/client";
...
const ActiveProjects = ({ projects }) => { 
  ...
  <Dialog open={open} onClose={() => {setOpen(false); setButtonText("Create")}} fullWidth>
		...
		<Card style={{width: "100%",display:"flex", flexDirection:"column", flexWrap:"nowrap", gap:"10px", padding:"20px", overflowY:"auto"}}>
  ...
  <div className="content">
    <div style={{display:"flex", justifyContent:"left", alignItems:"center", gap:"20px"}}>
				...
				<Grid item key={idx} xs={12} sm={6} md={4} lg={3}>
					...
					>
						<Box style={{textAlign:"center"}}>
							<h1>{el.name}</h1>
							<h5 style={{overflow:"hidden"}}>{el.project_desc}</h5>
						</Box>
