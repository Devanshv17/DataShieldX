  	...
  	<div style={{
  		...
  		zIndex:"100",
			...
			<Paper elevation={1} style={{
				...
				<Link href="/student/dashboard" onClick={() => {onTabChange(null, "Dashboard")}}><img src="/assets/logo.jpg" alt="Company Logo" width="150" height="40" borderRadius="50%"/></Link>
				<h5 style={{fontSize:"20pt"}}>DataShieldX</h5>
					...
					(<Tabs value={currentTab} onChange={(e, newVal) => {newVal !== "Chat" && onTabChange(null, newVal)}} sx={tabsStyle}>
						<Tab component="a" href="/student/dashboard" label="Dashboard" value="Dashboard" />
						<Tab component="a" href={`${process.env.NEXT_PUBLIC_ROCKETCHAT}`} label="Chat" value="Chat" />
						<Tab component="a" href="/student/dashboard?tab=Apps" label="Apps" value="Apps" />
					</Tabs>)}
			</Paper>
		</div>
  );
